...
func (m *defaultFolderModel) Insert(ctx context.Context, session sqlx.Session, data *Folder) (sql.Result, error) {
	...
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.FolderName, data.FileStoreId, data.FolderPath, data.DelState, data.DeleteTime, data.Version)
		}
		return conn.ExecCtx(ctx, query, data.FolderName, data.FileStoreId, data.FolderPath, data.DelState, data.DeleteTime, data.Version)
...
func (m *defaultFolderModel) Update(ctx context.Context, session sqlx.Session, data *Folder) (sql.Result, error) {
	...
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.FolderName, data.FileStoreId, data.FolderPath, data.DelState, data.DeleteTime, data.Version, data.Id)
		}
		return conn.ExecCtx(ctx, query, data.FolderName, data.FileStoreId, data.FolderPath, data.DelState, data.DeleteTime, data.Version, data.Id)
	}, cloudDiskFolderIdKey)
}
...
func (m *defaultFolderModel) UpdateWithVersion(ctx context.Context, session sqlx.Session, data *Folder) error {
	...
	sqlResult, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.FolderName, data.FileStoreId, data.FolderPath, data.DelState, data.DeleteTime, data.Version, data.Id, oldVersion)
		}
		return conn.ExecCtx(ctx, query, data.FolderName, data.FileStoreId, data.FolderPath, data.DelState, data.DeleteTime, data.Version, data.Id, oldVersion)
	}, cloudDiskFolderIdKey)
	if err != nil {
		return err
	}
