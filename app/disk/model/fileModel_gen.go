...
func (m *defaultFileModel) Insert(ctx context.Context, session sqlx.Session, data *File) (sql.Result, error) {
	...
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.FileName, data.FileHash, data.UserId, data.StoreId, data.ParentFolderId, data.Size, data.Postfix, data.DownloadNum, data.DelState, data.DeleteTime, data.Version)
		}
		return conn.ExecCtx(ctx, query, data.FileName, data.FileHash, data.UserId, data.StoreId, data.ParentFolderId, data.Size, data.Postfix, data.DownloadNum, data.DelState, data.DeleteTime, data.Version)
	}, cloudDiskFileIdKey)
}
...
func (m *defaultFileModel) Update(ctx context.Context, session sqlx.Session, data *File) (sql.Result, error) {
	...
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.FileName, data.FileHash, data.UserId, data.StoreId, data.ParentFolderId, data.Size, data.Postfix, data.DownloadNum, data.DelState, data.DeleteTime, data.Version, data.Id)
		}
		return conn.ExecCtx(ctx, query, data.FileName, data.FileHash, data.UserId, data.StoreId, data.ParentFolderId, data.Size, data.Postfix, data.DownloadNum, data.DelState, data.DeleteTime, data.Version, data.Id)
	}, cloudDiskFileIdKey)
}
...
func (m *defaultFileModel) UpdateWithVersion(ctx context.Context, session sqlx.Session, data *File) error {
	...
	sqlResult, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, data.FileName, data.FileHash, data.UserId, data.StoreId, data.ParentFolderId, data.Size, data.Postfix, data.DownloadNum, data.DelState, data.DeleteTime, data.Version, data.Id, oldVersion)
		}
		return conn.ExecCtx(ctx, query, data.FileName, data.FileHash, data.UserId, data.StoreId, data.ParentFolderId, data.Size, data.Postfix, data.DownloadNum, data.DelState, data.DeleteTime, data.Version, data.Id, oldVersion)
	}, cloudDiskFileIdKey)
	if err != nil {
		return err
	}
